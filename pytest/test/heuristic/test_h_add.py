...
from lapkt.core.lib.wrapper import STRIPS_Interface, H_Add
...
def test_h_add():
    four_action_blocks_problem = STRIPS_Interface(
        "blocks_domain.pddl", "blocks_problem.pddl"
    )

    process_pddl(
        "blocks_domain.pddl", "blocks_problem.pddl", four_action_blocks_problem
    )
