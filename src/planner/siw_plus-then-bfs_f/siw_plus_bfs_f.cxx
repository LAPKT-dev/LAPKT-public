...
void SIW_PLUS_BFS_F_Planner::setup(bool gen_match_tree)
{
...
float SIW_PLUS_BFS_F_Planner::do_stage_1(SIW_Plus_Fwd &engine, float &cost)
{
...
float SIW_PLUS_BFS_F_Planner::do_stage_2(Anytime_GBFS_H_Add_Rp_Fwd &engine, float B, float &cost)
{
...
void SIW_PLUS_BFS_F_Planner::report_no_solution(std::string reason)
{
	std::ofstream plan_stream(m_plan_filename.c_str());
...
void SIW_PLUS_BFS_F_Planner::solve()
{
