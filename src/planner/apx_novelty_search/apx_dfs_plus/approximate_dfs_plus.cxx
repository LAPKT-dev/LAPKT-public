...
Approximate_DFS_Plus::Approximate_DFS_Plus()
		: STRIPS_Interface(), m_iw_bound(2), m_log_filename("iw.log"), m_plan_filename("plan.ipc")
{
}

Approximate_DFS_Plus::Approximate_DFS_Plus(std::string domain_file, std::string instance_file)
...
void Approximate_DFS_Plus::setup(bool gen_match_tree)
{
...
float Approximate_DFS_Plus::do_search(DFS_Plus_Fwd &engine)
{
...
void Approximate_DFS_Plus::solve()
{
	...
	DFS_Plus_Fwd dfs_engine(search_prob, m_sampling_factor, m_sampling_strategy,
