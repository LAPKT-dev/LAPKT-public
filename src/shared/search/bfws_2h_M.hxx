...
public:
	...
	BFWS_2H_M( 	const Search_Model& search_problem ) 
		: BFWS_2H<Search_Model, First_Heuristic, Second_Heuristic, Relevant_Fluents_Heuristic, Open_List_Type >(search_problem), m_M(0) {	
	}
