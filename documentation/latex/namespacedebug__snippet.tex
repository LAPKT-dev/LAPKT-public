\hypertarget{namespacedebug__snippet}{}\doxysection{debug\+\_\+snippet Namespace Reference}
\label{namespacedebug__snippet}\index{debug\_snippet@{debug\_snippet}}
\doxysubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
\mbox{\Hypertarget{namespacedebug__snippet_a9ca7f9e6841d96abdd7669a08d4da10e}\label{namespacedebug__snippet_a9ca7f9e6841d96abdd7669a08d4da10e}} 
def {\bfseries wait\+\_\+debug} (str)
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\begin{DoxyVerb}Info- The below snippet is for use when debugging mixed Python and C++ code. 
