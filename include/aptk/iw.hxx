...
public:
	...
	: BRFS< Search_Model >(search_problem), m_pruned_B_count(0), m_B( infty ) {	   
		m_novelty_func = new Abstract_Novelty( search_problem );
	}

	virtual ~IW() {
		delete m_novelty_func;
	}
...
protected:
	bool   prune( Search_Node* n ){
		...
		m_novelty_func->eval( *n, node_novelty );
...
protected:
	...
	Abstract_Novelty*      			m_novelty_func;
