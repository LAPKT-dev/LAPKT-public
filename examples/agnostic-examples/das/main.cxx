...
typedef 	H1_Heuristic<Fwd_Search_Problem, H_Max_Evaluation_Function, true >	H_Max_Unit_Fwd;
typedef		Relaxed_Plan_Heuristic< Fwd_Search_Problem, H_Max_Unit_Fwd, true >	H_FF;
