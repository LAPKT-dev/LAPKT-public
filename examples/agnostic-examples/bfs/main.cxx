...
typedef		AT_BFS_SQ_SH< Fwd_Search_Problem, H_Add_Rp_Fwd, BFS_Open_List >		Anytime_BFS_H_Add_Rp_Fwd;
...
int main( int argc, char** argv ) {
	...
	float bfs_t = do_search( bfs_engine, plan_prob, 60.0f, "bfs.log" );
	...
	float wbfs_t = do_search( wbfs_engine, plan_prob, 60.0f, "wbfs.log" );
	
	std::cout << "Weighted BFS search completed in " << wbfs_t << " secs, check 'wbfs.log' for details" << std::endl;
